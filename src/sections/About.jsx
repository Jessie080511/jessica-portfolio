...
HTML5/CSS3, REST API, Selenium, MySQL, PostgresQL, OpenAl api, Git, IntelliJ, VSCode, AWS, Google Cloud Platform.
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            <img src="/assets/passion.png" alt="grid-3" className="w-full sm:h-[266px] h-fit object-contain" />
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">yanjie080511@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
